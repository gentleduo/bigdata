...
class ReadWrite {
  ...
  def reader2(): Unit = {
    ...
    spark.read
      ...
      .load("D:\\intellij-workspace\\bigdata\\spark\\data\\BeijingPM20100101_20151231.csv")
      .show(10)
  ...
  def writer1(): Unit = {
    // 2. 读取数据集
    val df: DataFrame = spark.read.option("header", true).csv("D:\\intellij-workspace\\bigdata\\spark\\data\\BeijingPM20100101_20151231.csv")
